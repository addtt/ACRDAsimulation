#
# OMNeT++/OMNEST Makefile for acrda
#
...
INCLUDE_PATH = -I. -Iinputfiles -Ioutputfiles -Iresults
...
depend:
	...
	$(Q)$(MAKEDEPEND) $(INCLUDE_PATH) -f Makefile -P\$$O/ -- $(MSG_CC_FILES)  ./*.cc inputfiles/*.cc outputfiles/*.cc results/*.cc
